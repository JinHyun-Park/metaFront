...
export default {
  ...
  components: { VirtualUserApplyPopup, ChrgrListPopup, ProcMsgPopup },
  ...
  methods: {
    ...
    save() {
      const confirmText = '신청정보를 진짜 수정하시겠습니까??';
      this.$gf.confirmOn(confirmText, this.savereq);
    },
    reqsetting() {
      fetchGetMcgReqNum({
        params: {

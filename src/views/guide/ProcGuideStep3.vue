  ...
  <section class="form_area border_group">
        ...
        >
          ...
          <div class="table_body">
            <ul class="table_row w-auto">
              ...
              <li class="td_cell">
                송/수신 측 시스템의 문제로 데이터를 처리하지 못하고 큐에 적체되는 경우 발생
              </li>
              <li class="td_cell">
                <input
                  type="checkbox"
            ...
            <ul class="table_row w-auto">
              ...
              <li class="td_cell">
                대외 연동 중 발생하는 오류내용을 확인(F002, F004는 대외기관 문제)
              </li>
              <li class="td_cell">
                <input
                  type="checkbox"
    ...
    >
      ...
      <section class="small_tabs">
        <ul>
          <li
            :class="{on: isSTabActive(1)}"
            @click="sTabChange(1)"
          >
            1. 기본 정보 신청
          </li>
          <li
            :class="{on: isSTabActive(2)}"
            @click="sTabChange(2)"
          >
            2. 인터페이스 상세정보 입력
          </li>
          <li
            :class="{on: isSTabActive(3)}"
            @click="sTabChange(3)"
          >
            3. 신청 내용 확인 및 승인요청/확인
          </li>
        </ul>
      </section>
      <div v-if="sTabNum===1">
        <div align="left">
          <img
            src="@/assets/images/procGuide_step1.png"
            width="1300"
          >
        </div>
      </div>
      <div v-if="sTabNum===2">
        <div align="left">
          <img
            src="@/assets/images/procGuide_step2.png"
            width="1300"
          >
        </div>
        <section class="form_area">
      ...
      <div v-if="sTabNum===3">
        <div align="left">
          <img
            src="@/assets/images/procGuide_step3-2.png"
            width="1300"
          >
        </div>
      </div>
